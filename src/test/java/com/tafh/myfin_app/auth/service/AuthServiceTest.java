...
////        UserEntity mappedUser = new UserEntity("john", "john@gmail.com", "hashed", RoleEnum.USER);
////        when(userMapper.toUserEntity("john", "john@gmail.com", "hashed", RoleEnum.USER)).thenReturn(mappedUser);
...
////        UserEntity user = new UserEntity("john", "john@gmail.com", "hashed", RoleEnum.USER);
