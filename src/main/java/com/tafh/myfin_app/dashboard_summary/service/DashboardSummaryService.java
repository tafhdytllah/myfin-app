...
public class DashboardSummaryService {
    ...
    public DashboardSummaryResponse getDashboard(String id) {
        ...
        BigDecimal totalIncome = transactionRepository.sumByAccountAndUserAndType(id, userId, TransactionType.INCOME);
        BigDecimal totalExpense = transactionRepository.sumByAccountAndUserAndType(id, userId, TransactionType.EXPENSE);
